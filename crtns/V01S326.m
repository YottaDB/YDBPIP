V01S326(%O,fDBTBL8,fDBTBL1)	; -  - SID= <DBTBL8> Index File Definition
	;
...
VTAB(fDBTBL8,fDBTBL1)	;
	...
	S %TAB(5)=$C(5,16,16)_"01U|*ZINDEXNM|[*]@ZINDEXNM|^DBTBL(%LIBS,8,FID,#5|if X?1A.AN|do VP1^V01S326(.fDBTBL8,.fDBTBL1)||99"
	S %TAB(6)=$C(5,70,1)_"00L|*DELFLG|[*]@DELFLG|||do VP2^V01S326(.fDBTBL8,.fDBTBL1)"
	S %TAB(7)=$C(7,16,29)_"01T12405|1|[DBTBL8]IDXDESC|||do VP3^V01S326(.fDBTBL8,.fDBTBL1)"
	S %TAB(8)=$C(7,70,8)_"20T12415|1|[DBTBL8]PARFID"
	S %TAB(9)=$C(9,16,60)_"01T12403|1|[DBTBL8]ORDERBY|@SELDI^DBSFUN(FID,.X):LIST:NOVAL||do VP4^V01S326(.fDBTBL8,.fDBTBL1)||||||120"
	S %TAB(10)=$C(10,16,8)_"01T12402|1|[DBTBL8]GLOBAL|||do VP5^V01S326(.fDBTBL8,.fDBTBL1)||||||40"
