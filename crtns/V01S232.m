V01S232(%O,fDBTBL1D,fDBTBL1)	;DBS - DBS - SID= <DBTBL1F> Files Definition (Structure Definition)
	;
...
VTAB(fDBTBL1D,fDBTBL1)	;
	...
	S %TAB(4)=$C(5,25,26)_"00T12401|1|[DBTBL1D]NOD|||do VP1^V01S232(.fDBTBL1D,.fDBTBL1)"
	S %TAB(5)=$C(5,64,2)_"00N12421|1|[DBTBL1D]POS|||do VP2^V01S232(.fDBTBL1D,.fDBTBL1)|do VP3^V01S232(.fDBTBL1D,.fDBTBL1)"
	S %TAB(6)=$C(6,25,1)_"00L12417|1|[DBTBL1D]ISMASTER|||do VP4^V01S232(.fDBTBL1D,.fDBTBL1)"
	S %TAB(7)=$C(9,1,79)_"00T12416|1|[DBTBL1D]CMP|||do VP5^V01S232(.fDBTBL1D,.fDBTBL1)||||||255"
	S %TAB(8)=$C(16,25,12)_"00U12418|1|[DBTBL1D]SFT|||do VP6^V01S232(.fDBTBL1D,.fDBTBL1)|||||~126~~1"
	S %TAB(9)=$C(16,54,3)_"00N12418|1|[DBTBL1D]SFD1|[DBCTLDELIM]||do VP7^V01S232(.fDBTBL1D,.fDBTBL1)||1|255||~126~~2"
	S %TAB(10)=$C(16,67,3)_"00N12418|1|[DBTBL1D]SFD2|[DBCTLDELIM]||do VP8^V01S232(.fDBTBL1D,.fDBTBL1)|||||~126~~3"
	S %TAB(11)=$C(16,76,2)_"00N12418|1|[DBTBL1D]SFP|||do VP9^V01S232(.fDBTBL1D,.fDBTBL1)|||||~126~~4"
