V01S160	;; -  - 5.3 - SID= <DBTBL1R> Rename Data Items
...
VTBL	; Create %TAB(array)
	...
	S %TAB(3)=$C(5,0,12)_"00U|*A(1)|[*]@OOE7|@SELDI^DBSFUN(FID,.X)||D VP1^V01S160"
	S %TAB(4)=$C(5,17,12)_"00U|*B(1)|[*]@ooe8|||D VP2^V01S160"
	S %TAB(5)=$C(5,40,12)_"00U|*C(1)|[*]@OOE9|@SELDI^DBSFUN(FID,.X)||D VP3^V01S160"
	S %TAB(6)=$C(5,57,12)_"00U|*D(1)|[*]@ooe10|||D VP4^V01S160"
	;
	Q
	;
	;
