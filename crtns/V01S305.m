V01S305(%O,fDBTBL1D,fDBTBL1)	;DBS -  - SID= <DBTBL1E> Files Definition - Detail
	;
...
VTAB(fDBTBL1D,fDBTBL1)	;
	...
	;
	;
	S %TAB(1)=$C(2,13,12)_"01U|*DI|[*]@DI|@SELDI^DBSFUN(FID,.X)||do VP1^V01S305(.fDBTBL1D,.fDBTBL1)"
	S %TAB(2)=$C(2,43,1)_"00L|*DELETE|[*]@DELETE|||do VP2^V01S305(.fDBTBL1D,.fDBTBL1)"
	S %TAB(3)=$C(2,58,10)_"20T12426|1|[DBTBL1D]USER|||||||||20"
	S %TAB(4)=$C(2,69,10)_"20D12425|1|[DBTBL1D]LTD"
	S %TAB(5)=$C(3,58,12)_"00U12427|1|[DBTBL1D]MDD|@SELDI^DBSFUN($$MDD^DBSDF(FID),.X)||do VP3^V01S305(.fDBTBL1D,.fDBTBL1)|do VP4^V01S305(.fDBTBL1D,.fDBTBL1)"
	S %TAB(6)=$C(4,58,20)_"00U12404|1|[DBTBL1D]DOM|[DBSDOM]||do VP5^V01S305(.fDBTBL1D,.fDBTBL1)"
	S %TAB(7)=$C(6,19,1)_"01U12409|1|[DBTBL1D]TYP|[DBCTLDVFM]||do VP6^V01S305(.fDBTBL1D,.fDBTBL1)"
	S %TAB(8)=$C(6,34,5)_"01N12402|1|[DBTBL1D]LEN|||do VP7^V01S305(.fDBTBL1D,.fDBTBL1)"
	S %TAB(9)=$C(6,58,3)_"00N12419|1|[DBTBL1D]SIZ|||do VP8^V01S305(.fDBTBL1D,.fDBTBL1)||1"
	S %TAB(10)=$C(6,73,2)_"00N12414|1|[DBTBL1D]DEC|||||0|18"
	S %TAB(11)=$C(7,19,40)_"01T12410|1|[DBTBL1D]DES|||do VP9^V01S305(.fDBTBL1D,.fDBTBL1)"
	S %TAB(12)=$C(8,19,40)_"01T12422|1|[DBTBL1D]RHD"
	S %TAB(13)=$C(10,19,60)_"00T12405|1|[DBTBL1D]TBL|||do VP10^V01S305(.fDBTBL1D,.fDBTBL1)||||||255"
	S %TAB(14)=$C(11,19,60)_"00T12406|1|[DBTBL1D]PTN|||do VP11^V01S305(.fDBTBL1D,.fDBTBL1)"
	S %TAB(15)=$C(12,19,58)_"00T12403|1|[DBTBL1D]DFT|||do VP12^V01S305(.fDBTBL1D,.fDBTBL1)|do VP13^V01S305(.fDBTBL1D,.fDBTBL1)"
	S %TAB(16)=$C(13,19,25)_"00T12412|1|[DBTBL1D]MIN|||do VP14^V01S305(.fDBTBL1D,.fDBTBL1)"
	S %TAB(17)=$C(14,19,25)_"00T12413|1|[DBTBL1D]MAX|||do VP15^V01S305(.fDBTBL1D,.fDBTBL1)"
	...
	S %TAB(22)=$C(21,11,1)_"00L12415|1|[DBTBL1D]REQ|||do VP16^V01S305(.fDBTBL1D,.fDBTBL1)"
	S %TAB(23)=$C(21,36,1)_"00L12428|1|[DBTBL1D]VAL4EXT|||do VP17^V01S305(.fDBTBL1D,.fDBTBL1)|do VP18^V01S305(.fDBTBL1D,.fDBTBL1)"
