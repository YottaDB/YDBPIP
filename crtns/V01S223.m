V01S223	;; -  - 5.3 - SID= <DBSQCONV> Training-convert query to SQL
...
VTBL	; Create %TAB(array)
	...
	;
	S %TAB(1)=$C(2,15,60)_"01T|*FILE|[*]@FILE|[DBTBL1]||D VP1^V01S223"
	S %TAB(2)=$C(4,2,76)_"00T|*QRY(1)|[*]@QRY|||D VP2^V01S223"
	;
	Q
	;
	;
