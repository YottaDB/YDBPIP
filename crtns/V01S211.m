V01S211(%O,DBTBL6F)	; -  - SID= <DBTBL6F> QWIK Report Display Format Definition
	;
...
VTAB(DBTBL6F)	;
	...
	S %TAB(2)=$C(4,14,35)_"00T12402|1|[DBTBL6F]FORMDESC|||do VP1^V01S211(.DBTBL6F)"
	S %TAB(3)=$C(4,50,3)_"01N12403|1|[DBTBL6F]FORMIDN|||||0|508"
	S %TAB(4)=$C(4,54,3)_"01N12404|1|[DBTBL6F]FORMSIZE|||do VP2^V01S211(.DBTBL6F)||1|508"
	S %TAB(5)=$C(4,59,11)_"01T12405|1|[DBTBL6F]FORMFMT|[DBCTLRFMT]||do VP3^V01S211(.DBTBL6F)||||||20"
	S %TAB(6)=$C(4,71,3)_"00T12406|1|[DBTBL6F]FORMFUN|[DBCTLQFUN]"
	S %TAB(7)=$C(4,76,2)_"00N12407|1|[DBTBL6F]FORMLF|||do VP4^V01S211(.DBTBL6F)||1|99"
	D VTBL(.DBTBL6F)
