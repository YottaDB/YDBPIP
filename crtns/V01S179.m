V01S179	;; -  - 5.3 - SID= <DBTBL9> Journal File Definition
...
VLOD	; Load data from disc - %O = (1-5)
	...
	I $G(%LOGID) D  Q
	. ;
	. D STUB^DBSCLI("VLOD^V01S179",65,,%LIBS_$C(28)_PRITABLE_$C(28)_JRNID,,"v") I ER K %RPC Q
...
VTBL	; Create %TAB(array)
	...
	S %TAB(12)=$C(9,77,1)_"00L|*Convt|[*]@CONVT|||D VP1^V01S179"
	S %TAB(13)=$C(10,44,1)_"00L|*Insert|[*]@INSERT|||D VP2^V01S179"
	S %TAB(14)=$C(10,61,1)_"00L|*Update|[*]@UPDATE|||D VP3^V01S179"
	S %TAB(15)=$C(10,77,1)_"00L|*Delete|[*]@DELETE|||D VP4^V01S179"
	S %TAB(16)=$C(11,44,1)_"00L|*nonefd|[*]@nonefd"
	S %TAB(17)=$C(11,61,1)_"00L|*efd|[*]@EFD|||D VP5^V01S179"
	S %TAB(18)=$C(13,3,76)_"00T12415||[DBTBL9]IFCOND|||||||||255"
	S %TAB(19)=$C(16,29,51)_"00U12407||[DBTBL9]INCOLUMN|[DBTBL1D]DI,DES:LIST:QU ""[DBTBL1D]FID=<<PRITABLE>>""||D VP6^V01S179||||||250"
	S %TAB(20)=$C(17,29,51)_"00U12406||[DBTBL9]EXCOLUMN|[DBTBL1D]DI,DES:LIST:QU ""[DBTBL1D]FID=<<PRITABLE>>""||||||||250"
	S %TAB(21)=$C(20,3,76)_"00T12411||[DBTBL9]QUERY1|||D VP7^V01S179||||||100"
	S %TAB(22)=$C(21,3,76)_"00T12412||[DBTBL9]QUERY2|||D VP8^V01S179||||||100"
	;
	Q
	;
	;
