...
equals(s1,s2,nCase)	;
	...
	;
vSIG()	;
	Q "60528^29025^Frans S.C. Witte^22661" ; Signature - LTD^TIME^USER^SIZE
	; ----------------
...
vFetch4()	;
	...
	S rs=$S(vos3=$C(254):"",1:vos3)_$C(9)_$P(vos5,"|",1)_$C(9)_$P(vos5,"|",3)_$C(9)_$P(vos5,"|",4)_$C(9)_$P(vos5,"|",5)_$C(9)_$P(vos5,"|",6)_$C(9)_$P(vos5,"|",7)_$C(9)_$P(vos4,"|",1)_$C(9)_$P(vos4,"|",2)
	;
	Q 1
	;
