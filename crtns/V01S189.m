V01S189(%O,fDBTBL1)	;DBS -  - SID= <DBTBL1> File Definition
	;
...
VTAB(fDBTBL1)	;
	...
	S %TAB(9)=$C(7,22,12)_"00T12401|1|[DBTBL1]FSN||if X?1A.AN.E!(X?1""%"".AN.E)|do VP1^V01S189(.fDBTBL1)"
	S %TAB(10)=$C(7,67,4)_"00U12403|1|[DBTBL1]FPN"
	S %TAB(11)=$C(8,22,30)_"00T12406|1|[DBTBL1]PUBLISH"
	S %TAB(12)=$C(8,67,1)_"01N12412|1|[DBTBL1]FILETYP|[DBCTLFILETYP]||do VP2^V01S189(.fDBTBL1)"
	S %TAB(13)=$C(9,22,8)_"00U12401|1|[DBTBL1]UDACC"
	S %TAB(14)=$C(9,67,8)_"00U12402|1|[DBTBL1]UDFILE|||do VP3^V01S189(.fDBTBL1)"
	S %TAB(15)=$C(10,22,58)_"01U12401|1|[DBTBL1]ACCKEYS|@SELDI^DBSFUN(FID,.X)||do VP4^V01S189(.fDBTBL1)||||||100"
	S %TAB(16)=$C(12,22,1)_"01N12403|1|[DBTBL1]NETLOC|,0#Server Only,1#Client Only,2#Both||do VP5^V01S189(.fDBTBL1)"
	S %TAB(17)=$C(12,43,1)_"00L12405|1|[DBTBL1]LOG|||do VP6^V01S189(.fDBTBL1)"
	S %TAB(18)=$C(12,60,2)_"01N12402|1|[DBTBL1]RECTYP|,0#None,1#Unsegmented,10#Node [Segmented],11#Mixed type 1&10||do VP7^V01S189(.fDBTBL1)"
	S %TAB(19)=$C(12,75,3)_"00N12401|1|[DBTBL1]DEL|[DBCTLDELIM]"
	S %TAB(20)=$C(14,3,76)_"00T12406|1|[DBTBL1]DFTDES|@SELDI^DBSFUN(FID,.X)||do VP8^V01S189(.fDBTBL1)||||||200"
	S %TAB(21)=$C(15,3,76)_"00T12409|1|[DBTBL1]DFTDES1|@SELDI^DBSFUN(FID,.X)||do VP9^V01S189(.fDBTBL1)||||||200"
	S %TAB(22)=$C(16,10,65)_"00T12401|1|[DBTBL1]QID1|||do VP10^V01S189(.fDBTBL1)||||||100"
	...
	S %TAB(26)=$C(20,45,12)_"00U12404|1|[DBTBL1]PTRTLD|[DBTBL1D]:QU ""[DBTBL1D]FID=<<FID>>""||do VP11^V01S189(.fDBTBL1)"
	S %TAB(27)=$C(20,65,12)_"00U12408|1|[DBTBL1]PTRTIM|[DBTBL1D]:QU ""[DBTBL1D]FID=<<FID>>""||do VP12^V01S189(.fDBTBL1)"
	S %TAB(28)=$C(21,25,12)_"00U12409|1|[DBTBL1]PTRUSERU|[DBTBL1D]:QU ""[DBTBL1D]FID=<<FID>>"""
	S %TAB(29)=$C(21,45,12)_"00U12410|1|[DBTBL1]PTRTLDU|[DBTBL1D]:QU ""[DBTBL1D]FID=<<FID>>""||do VP13^V01S189(.fDBTBL1)"
	S %TAB(30)=$C(21,65,12)_"00U12411|1|[DBTBL1]PTRTIMU|[DBTBL1D]:QU ""[DBTBL1D]FID=<<FID>>""||do VP14^V01S189(.fDBTBL1)"
	D VTBL(.fDBTBL1)
