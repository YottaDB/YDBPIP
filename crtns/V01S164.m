V01S164(%O,dbtbl22r)	; -  - SID= <DBTBL22R> DATA-QWIK Row Definition
	;
...
VTAB(dbtbl22r)	;
	...
	;
	;
	S %TAB(1)=$C(1,29,4)_"01N|*ROW|[*]@ROW|[DBTBL22R]ROW,DES/LE=30,WHR1/LE=20:NOVAL:QU ""AGID=<<AGID>>""||do VP1^V01S164(.dbtbl22r)"
	S %TAB(2)=$C(1,50,1)_"00L|*DELETE|[*]@DELETE|,0#Insert,1#Modify,3#Delete||do VP2^V01S164(.dbtbl22r)"
