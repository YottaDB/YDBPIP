V01S200(%O,dbtbl22c)	;DBS -  - SID= <DBTBL22C> DATA-QWIK Aggregate Column definition
	;
...
VTAB(dbtbl22c)	;
	...
	;
	;
	S %TAB(1)=$C(1,31,4)_"01U|*COL|[*]@COL|[DBTBL22C]COL,DES/LE=30,EXP/LE=12,FUN:NOVAL:QU ""AGID=<<AGID>>""|if X?1A.A|do VP1^V01S200(.dbtbl22c)"
	S %TAB(2)=$C(1,55,1)_"00L|*DELETE|[*]@DELETE|,0#Insert,1#Modify,3#Delete||do VP2^V01S200(.dbtbl22c)"
	S %TAB(3)=$C(2,31,40)_"01T12401|1|[DBTBL22C]DES"
	S %TAB(4)=$C(3,31,20)_"01T12404|1|[DBTBL22C]EXP||||do VP3^V01S200(.dbtbl22c)|||||255"
	S %TAB(5)=$C(4,31,3)_"01U12403|1|[DBTBL22C]FUN|,SUM#Sum,MIN#Minimum,MAX#MAximum,AVG#Average,CNT#Count"
	S %TAB(6)=$C(6,31,4)_"00U12406|1|[DBTBL22C]LNK|[DBTBL22C]COL,DES/LE=30,WHR1/LE=30:QU ""AGID=<<AGID>>""||do VP4^V01S200(.dbtbl22c)"
