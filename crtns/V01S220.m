V01S220(%O,DBTBL2)	;DBS - DBS - SID= <DBSDSMP> Screen Definition - Multiple
	;
...
VTAB(DBTBL2)	;
	...
	S %TAB(6)=$C(6,16,60)_"01U12401|1|[DBTBL2]PFID|[DBTBL1]||do VP1^V01S220(.DBTBL2)"
	...
	S %TAB(11)=$C(14,6,12)_"01U12401|1|[DBTBL2]LNK1|[DBTBL2]||do VP2^V01S220(.DBTBL2)"
	S %TAB(12)=$C(14,25,12)_"01U12402|1|[DBTBL2]LNK2|[DBTBL2]||do VP3^V01S220(.DBTBL2)"
	S %TAB(13)=$C(14,45,12)_"00U12403|1|[DBTBL2]LNK3|[DBTBL2]||do VP4^V01S220(.DBTBL2)"
	S %TAB(14)=$C(14,65,12)_"00U12404|1|[DBTBL2]LNK4|[DBTBL2]||do VP5^V01S220(.DBTBL2)"
	S %TAB(15)=$C(15,6,12)_"00U12405|1|[DBTBL2]LNK5|[DBTBL2]||do VP6^V01S220(.DBTBL2)"
	S %TAB(16)=$C(15,25,12)_"00U12406|1|[DBTBL2]LNK6|[DBTBL2]||do VP7^V01S220(.DBTBL2)"
	S %TAB(17)=$C(15,45,12)_"00U12407|1|[DBTBL2]LNK7|[DBTBL2]||do VP8^V01S220(.DBTBL2)"
	S %TAB(18)=$C(15,65,12)_"00U12408|1|[DBTBL2]LNK8|[DBTBL2]||do VP9^V01S220(.DBTBL2)"
	S %TAB(19)=$C(16,6,12)_"00U12409|1|[DBTBL2]LNK9|[DBTBL2]||do VP10^V01S220(.DBTBL2)"
	S %TAB(20)=$C(16,25,12)_"00U12410|1|[DBTBL2]LNK10|[DBTBL2]||do VP11^V01S220(.DBTBL2)"
	S %TAB(21)=$C(16,45,12)_"00U12411|1|[DBTBL2]LNK11|[DBTBL2]||do VP12^V01S220(.DBTBL2)"
	S %TAB(22)=$C(16,65,12)_"00U12412|1|[DBTBL2]LNK12|[DBTBL2]||do VP13^V01S220(.DBTBL2)"
	S %TAB(23)=$C(17,6,12)_"00U12413|1|[DBTBL2]LNK13|[DBTBL2]||do VP14^V01S220(.DBTBL2)"
	S %TAB(24)=$C(17,25,12)_"00U12414|1|[DBTBL2]LNK14|[DBTBL2]||do VP15^V01S220(.DBTBL2)"
	S %TAB(25)=$C(17,45,12)_"00U12415|1|[DBTBL2]LNK15|[DBTBL2]||do VP16^V01S220(.DBTBL2)"
	S %TAB(26)=$C(17,65,12)_"00U12416|1|[DBTBL2]LNK16|[DBTBL2]||do VP17^V01S220(.DBTBL2)"
	S %TAB(27)=$C(18,6,12)_"00U12417|1|[DBTBL2]LNK17|[DBTBL2]||do VP18^V01S220(.DBTBL2)"
	S %TAB(28)=$C(18,25,12)_"00U12418|1|[DBTBL2]LNK18|[DBTBL2]||do VP19^V01S220(.DBTBL2)"
	S %TAB(29)=$C(18,45,12)_"00U12419|1|[DBTBL2]LNK19|[DBTBL2]||do VP20^V01S220(.DBTBL2)"
	S %TAB(30)=$C(18,65,12)_"00U12420|1|[DBTBL2]LNK20|[DBTBL2]||do VP21^V01S220(.DBTBL2)"
	S %TAB(31)=$C(19,6,12)_"00U12421|1|[DBTBL2]LNK21|[DBTBL2]||do VP22^V01S220(.DBTBL2)"
	S %TAB(32)=$C(19,25,12)_"00U12422|1|[DBTBL2]LNK22|[DBTBL2]||do VP23^V01S220(.DBTBL2)"
	S %TAB(33)=$C(19,45,12)_"00U12423|1|[DBTBL2]LNK23|[DBTBL2]||do VP24^V01S220(.DBTBL2)"
	S %TAB(34)=$C(19,65,12)_"00U12424|1|[DBTBL2]LNK24|[DBTBL2]||do VP25^V01S220(.DBTBL2)"
