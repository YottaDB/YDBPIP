V01S173	;; -  - 5.3 - SID= <DBTBL5SQ> Report Definition - Statistics
...
VLOD	; Load data from disc - %O = (1-5)
	...
	I $G(%LOGID) D  Q
	. ;
	. D STUB^DBSCLI("VLOD^V01S173",61,,LIBS_$C(28)_RID,,"v") I ER K %RPC Q
...
VTBL	; Create %TAB(array)
	...
	;
	S %TAB(1)=$C(3,1,25)_"00T12404|11|[DBTBL5H]STATTRGT1|||D VP1^V01S173|D VP2^V01S173"
	S %TAB(2)=$C(3,27,25)_"00T12401|11|[DBTBL5H]STATSRC1|||D VP3^V01S173|D VP4^V01S173"
	S %TAB(3)=$C(3,53,26)_"00T12405|11|[DBTBL5H]STATINC1|||D VP5^V01S173"
	S %TAB(4)=$C(4,1,25)_"00T12404|12|[DBTBL5H]STATTRGT2|||D VP6^V01S173|D VP7^V01S173"
	S %TAB(5)=$C(4,27,25)_"00T12401|12|[DBTBL5H]STATSRC2|||D VP8^V01S173|D VP9^V01S173"
	S %TAB(6)=$C(4,53,26)_"00T12405|12|[DBTBL5H]STATINC2|||D VP10^V01S173"
	S %TAB(7)=$C(5,1,25)_"00T12404|13|[DBTBL5H]STATTRGT3|||D VP11^V01S173|D VP12^V01S173"
	S %TAB(8)=$C(5,27,25)_"00T12401|13|[DBTBL5H]STATSRC3|||D VP13^V01S173|D VP14^V01S173"
	S %TAB(9)=$C(5,53,26)_"00T12405|13|[DBTBL5H]STATINC3|||D VP15^V01S173"
	S %TAB(10)=$C(6,1,25)_"00T12404|14|[DBTBL5H]STATTRGT4|||D VP16^V01S173|D VP17^V01S173"
	S %TAB(11)=$C(6,27,25)_"00T12401|14|[DBTBL5H]STATSRC4|||D VP18^V01S173|D VP19^V01S173"
	S %TAB(12)=$C(6,53,26)_"00T12405|14|[DBTBL5H]STATINC4|||D VP20^V01S173"
	S %TAB(13)=$C(7,1,25)_"00T12404|15|[DBTBL5H]STATTRGT5|||D VP21^V01S173|D VP22^V01S173"
	S %TAB(14)=$C(7,27,25)_"00T12401|15|[DBTBL5H]STATSRC5|||D VP23^V01S173|D VP24^V01S173"
	S %TAB(15)=$C(7,53,26)_"00T12405|15|[DBTBL5H]STATINC5|||D VP25^V01S173"
	S %TAB(16)=$C(8,1,25)_"00T12404|16|[DBTBL5H]STATTRGT6|||D VP26^V01S173|D VP27^V01S173"
	S %TAB(17)=$C(8,27,25)_"00T12401|16|[DBTBL5H]STATSRC6|||D VP28^V01S173|D VP29^V01S173"
	S %TAB(18)=$C(8,53,26)_"00T12405|16|[DBTBL5H]STATINC6|||D VP30^V01S173"
	S %TAB(19)=$C(9,1,25)_"00T12404|17|[DBTBL5H]STATTRGT7|||D VP31^V01S173|D VP32^V01S173"
	S %TAB(20)=$C(9,27,25)_"00T12401|17|[DBTBL5H]STATSRC7|||D VP33^V01S173|D VP34^V01S173"
	S %TAB(21)=$C(9,53,26)_"00T12405|17|[DBTBL5H]STATINC7|||D VP35^V01S173"
	S %TAB(22)=$C(10,1,25)_"00T12404|18|[DBTBL5H]STATTRGT8|||D VP36^V01S173|D VP37^V01S173"
	S %TAB(23)=$C(10,27,25)_"00T12401|18|[DBTBL5H]STATSRC8|||D VP38^V01S173|D VP39^V01S173"
	S %TAB(24)=$C(10,53,26)_"00T12405|18|[DBTBL5H]STATINC8|||D VP40^V01S173"
	S %TAB(25)=$C(11,1,25)_"00T12404|19|[DBTBL5H]STATTRGT9|||D VP41^V01S173|D VP42^V01S173"
	S %TAB(26)=$C(11,27,25)_"00T12401|19|[DBTBL5H]STATSRC9|||D VP43^V01S173|D VP44^V01S173"
	S %TAB(27)=$C(11,53,26)_"00T12405|19|[DBTBL5H]STATINC9|||D VP45^V01S173"
	S %TAB(28)=$C(12,1,25)_"00T12404|20|[DBTBL5H]STATTRGT10|||D VP46^V01S173|D VP47^V01S173"
	S %TAB(29)=$C(12,27,25)_"00T12401|20|[DBTBL5H]STATSRC10|||D VP48^V01S173|D VP49^V01S173"
	S %TAB(30)=$C(12,53,26)_"00T12405|20|[DBTBL5H]STATINC10|||D VP50^V01S173"
	S %TAB(31)=$C(13,1,25)_"00T12404|21|[DBTBL5H]STATTRGT11|||D VP51^V01S173|D VP52^V01S173"
	S %TAB(32)=$C(13,27,25)_"00T12401|21|[DBTBL5H]STATSRC11|||D VP53^V01S173|D VP54^V01S173"
	S %TAB(33)=$C(13,53,26)_"00T12405|21|[DBTBL5H]STATINC11|||D VP55^V01S173"
	S %TAB(34)=$C(14,1,25)_"00T12404|22|[DBTBL5H]STATTRGT12|||D VP56^V01S173|D VP57^V01S173"
	S %TAB(35)=$C(14,27,25)_"00T12401|22|[DBTBL5H]STATSRC12|||D VP58^V01S173|D VP59^V01S173"
	S %TAB(36)=$C(14,53,26)_"00T12405|22|[DBTBL5H]STATINC12|||D VP60^V01S173"
	S %TAB(37)=$C(15,1,25)_"00T12404|23|[DBTBL5H]STATTRGT13|||D VP61^V01S173|D VP62^V01S173"
	S %TAB(38)=$C(15,27,25)_"00T12401|23|[DBTBL5H]STATSRC13|||D VP63^V01S173|D VP64^V01S173"
	S %TAB(39)=$C(15,53,26)_"00T12405|23|[DBTBL5H]STATINC13|||D VP65^V01S173"
	S %TAB(40)=$C(16,1,25)_"00T12404|24|[DBTBL5H]STATTRGT14|||D VP66^V01S173|D VP67^V01S173"
	S %TAB(41)=$C(16,27,25)_"00T12401|24|[DBTBL5H]STATSRC14|||D VP68^V01S173|D VP69^V01S173"
	S %TAB(42)=$C(16,53,26)_"00T12405|24|[DBTBL5H]STATINC14|||D VP70^V01S173"
	S %TAB(43)=$C(17,1,25)_"00T12404|25|[DBTBL5H]STATTRGT15|||D VP71^V01S173|D VP72^V01S173"
	S %TAB(44)=$C(17,27,25)_"00T12401|25|[DBTBL5H]STATSRC15|||D VP73^V01S173|D VP74^V01S173"
	S %TAB(45)=$C(17,53,26)_"00T12405|25|[DBTBL5H]STATINC15|||D VP75^V01S173"
	S %TAB(46)=$C(18,1,25)_"00T12404|26|[DBTBL5H]STATTRGT16|||D VP76^V01S173|D VP77^V01S173"
	S %TAB(47)=$C(18,27,25)_"00T12401|26|[DBTBL5H]STATSRC16|||D VP78^V01S173|D VP79^V01S173"
	S %TAB(48)=$C(18,53,26)_"00T12405|26|[DBTBL5H]STATINC16|||D VP80^V01S173"
	S %TAB(49)=$C(19,1,25)_"00T12404|27|[DBTBL5H]STATTRGT17|||D VP81^V01S173|D VP82^V01S173"
	S %TAB(50)=$C(19,27,25)_"00T12401|27|[DBTBL5H]STATSRC17|||D VP83^V01S173|D VP84^V01S173"
	S %TAB(51)=$C(19,53,26)_"00T12405|27|[DBTBL5H]STATINC17|||D VP85^V01S173"
	S %TAB(52)=$C(20,1,25)_"00T12404|28|[DBTBL5H]STATTRGT18|||D VP86^V01S173|D VP87^V01S173"
	S %TAB(53)=$C(20,27,25)_"00T12401|28|[DBTBL5H]STATSRC18|||D VP88^V01S173|D VP89^V01S173"
	S %TAB(54)=$C(20,53,26)_"00T12405|28|[DBTBL5H]STATINC18|||D VP90^V01S173"
	S %TAB(55)=$C(21,1,25)_"00T12404|29|[DBTBL5H]STATTRGT19|||D VP91^V01S173|D VP92^V01S173"
	S %TAB(56)=$C(21,27,25)_"00T12401|29|[DBTBL5H]STATSRC19|||D VP93^V01S173|D VP94^V01S173"
	S %TAB(57)=$C(21,53,26)_"00T12405|29|[DBTBL5H]STATINC19|||D VP95^V01S173"
	S %TAB(58)=$C(22,1,25)_"00T12404|30|[DBTBL5H]STATTRGT20|||D VP96^V01S173|D VP97^V01S173"
	S %TAB(59)=$C(22,27,25)_"00T12401|30|[DBTBL5H]STATSRC20|||D VP98^V01S173|D VP99^V01S173"
	S %TAB(60)=$C(22,53,26)_"00T12405|30|[DBTBL5H]STATINC20|||D VP100^V01S173"
	;
	Q
	;
	;
