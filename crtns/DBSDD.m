...
PARSE(ddexpr,X,cmp,fsn,frm,vdd,lvn,vsub)	;
	...
	;
	I del S NS="$P("_NS_","_$S(del<32:"$C("_del_")",1:""""_$char(del)_"""")_","_$S(fld:fld,1:1)_")"
	;
...
FIELD(ddexpr,loc,x,vdd)	;
	...
	;
vSIG()	;
	Q "60442^53213^e0101489^32303" ; Signature - LTD^TIME^USER^SIZE
	; ----------------
...
vFetch3()	;
	...
	I vos1=0 Q 0
	;
	S rs=$S(vos5=$C(254):"",1:vos5)_$C(9)_$S(vos3=$C(254):"",1:vos3)_$C(9)_$S(vos4=$C(254):"",1:vos4)
	;
	Q 1
	;
