...
isDoScope(pslSt,outer)	;
	...
	;
	; ---------------------------------------------------------------------
new(doVal,ifVal,forVal)	;
	Q doVal_"|"_ifVal_"|"_forVal
	;
	; ---------------------------------------------------------------------
pop(pslSt,doVal,ifFl,forFl)	;
...
topIf(pslSt)	; PSLState "object"
	...
	;
vSIG()	;
	Q "60366^45105^Frans S.C. Witte^8549" ; Signature - LTD^TIME^USER^SIZE
