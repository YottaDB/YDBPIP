V01S176(%O,fDBTBL6S)	;DBS - DBS - SID= <DBTBL6S> QWIK Definition - Statistics
	;
...
VTAB(fDBTBL6S)	;
	...
	F I=4:1:%MAX S %TAB(I)=""
	;
	S %TAB(1)=$C(3,1,25)_"00T12404|1|[DBTBL6SQ]QDI|||do VP1^V01S176(.fDBTBL6S)|do VP2^V01S176(.fDBTBL6S)|||||40"
	S %TAB(2)=$C(3,27,25)_"00T12401|1|[DBTBL6SQ]QBASE|||do VP3^V01S176(.fDBTBL6S)|do VP4^V01S176(.fDBTBL6S)|||||40"
	S %TAB(3)=$C(3,53,26)_"00T12405|1|[DBTBL6SQ]QINCR|||do VP5^V01S176(.fDBTBL6S)||||||40"
	D VTBL(.fDBTBL6S)
