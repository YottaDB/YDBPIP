R01S190	; DBSJRNLST - Journal File Definition Report
	;
...
VHDG5	; Group Header
	...
	S VL=VL_$J("",24-23)_$E(vc11,1,100)
	D VOM
	S VL="       "_"Exclude Columns:"
	S VL=VL_$J("",24-23)_$E(vc12,1,100)
	D VOM
	S VL="       "_"Query Condition:"
	S VL=VL_$J("",24-23)_$E(vc13,1,100)
	D VOM
	S VL="                        "_$E(vc14,1,100)
	D VOM
