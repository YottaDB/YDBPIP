V01S004	;; -  - 5.3 - SID= <DBSFMT> DQ Format Type Definition
...
VTAB	; Data Entry Control Table %TAB(NI
	...
	S %MODOFF=1,%MOD=6,%MAX=%MOD*%REPEAT+%MODOFF,VPT=1,VPB=7+%REPEAT,BLKSIZ=79*%REPEAT+20,PGM=$T(+0),DLIB="SYSDEV",DFID=""
	S OLNTB=VPB*1000
	;
	F I=8:1:%MAX S %TAB(I)=""
	;
...
VTBL	; Create %TAB(array)
	...
	S %TAB(7)=$C(7,113,3)_"00N12409|*ZTYPE(1)|[*]@ZTYPE||||D VP1^V01S004"
	;
	Q
	;
	;
