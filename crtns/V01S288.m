V01S288(%O,fDBTBL7)	;DBS -  - SID= <DBTBL7> Trigger Definition
	;
...
VTAB(fDBTBL7)	;
	...
	S %TAB(7)=$C(9,26,1)_"00L12402|1|[DBTBL7]ACTBI|||do VP1^V01S288(.fDBTBL7)"
	S %TAB(8)=$C(9,46,1)_"00L12403|1|[DBTBL7]ACTBU"
	S %TAB(9)=$C(9,67,1)_"00L12404|1|[DBTBL7]ACTBD|||do VP2^V01S288(.fDBTBL7)"
	S %TAB(10)=$C(10,26,1)_"00L12405|1|[DBTBL7]ACTAI|||do VP3^V01S288(.fDBTBL7)"
	S %TAB(11)=$C(10,46,1)_"00L12406|1|[DBTBL7]ACTAU"
	S %TAB(12)=$C(10,67,1)_"00L12407|1|[DBTBL7]ACTAD|||do VP4^V01S288(.fDBTBL7)"
	S %TAB(13)=$C(14,2,76)_"00U12408|1|[DBTBL7]COLUMNS|||do VP5^V01S288(.fDBTBL7)||||||255"
