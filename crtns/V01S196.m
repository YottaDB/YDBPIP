V01S196(%O,fDBTBL1F,fDBTBL1)	;DBS - DBS - SID= <DBTBL1K> Foreign Key Definition
	;
...
VTAB(fDBTBL1F,fDBTBL1)	;
	...
	S %TAB(3)=$C(3,19,60)_"01U|*FKEYS|[*]@OOE8|[DBTBL1F]:NOVAL||do VP1^V01S196(.fDBTBL1F,.fDBTBL1)|do VP2^V01S196(.fDBTBL1F,.fDBTBL1)"
	S %TAB(4)=$C(5,20,1)_"00L|*DELETE|[*]@DELETE|||do VP3^V01S196(.fDBTBL1F,.fDBTBL1)"
	S %TAB(5)=$C(7,20,12)_"01U12405|1|[DBTBL1F]TBLREF|[DBTBL1]|if X?1A.AN!(X?1""%"".AN)!(X?.A.""_"".E)|do VP4^V01S196(.fDBTBL1F,.fDBTBL1)||||||256"
	...
	S %TAB(16)=$C(16,21,1)_"01N12404|1|[DBTBL1F]UPD|[STBLFKOPT]||do VP5^V01S196(.fDBTBL1F,.fDBTBL1)"
	S %TAB(17)=$C(16,68,1)_"01N12403|1|[DBTBL1F]DEL|[STBLFKOPT]||do VP6^V01S196(.fDBTBL1F,.fDBTBL1)"
