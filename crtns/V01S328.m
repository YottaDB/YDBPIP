V01S328	;; -  - 5.3 - SID= <DBTBL9D> Journal File Mapping Definition
...
VTBL	; Create %TAB(array)
	...
	S %TAB(6)=$C(6,44,31)_"00T|*Pri2sub(1)|[*]@[DBTBL9D]MAP|[STBLJRNFUNC]DES:NOVAL||D VP1^V01S328|D VP2^V01S328|||||200"
	;
	Q
	;
	;
