...
vSIG()	;
	Q "60662^55394^Pete Chenard^6219" ; Signature - LTD^TIME^USER^SIZE
	;
...
vL1a1	S vos2=$G(SID) I vos2="" G vL1a0
	S vos3=$G(SEQ) I vos3="" G vL1a0
	S vos3=+vos3
	S vos4=$G(PP) I vos4="",'$D(PP) G vL1a0
	S vos5=$G(NN) I vos5="",'$D(NN) G vL1a0
	S vos6=vos4
	I $D(^DBTBL("SYSDEV",2,vos2,vos3,vos6)),'(vos6>vos5) G vL1a9
vL1a8	S vos6=$O(^DBTBL("SYSDEV",2,vos2,vos3,vos6),1) I vos6=""!(vos6>vos5) G vL1a0
vL1a9	Q
	;
vFetch1()	;
	;
	...
	I vos1=0 Q 0
	;
	S ds="SYSDEV"_$C(9)_vos2_$C(9)_vos3_$C(9)_$S(vos6=$$BYTECHAR^SQLUTL(254):"",1:vos6)
	;
	Q 1
