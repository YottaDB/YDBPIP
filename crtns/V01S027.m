V01S027	;; -  - 5.3 - SID= <DBTBL5H1> Report Definition - Header (part 2)
...
VTBL	; Create %TAB(array)
	...
	S %TAB(2)=$C(10,1,33)_"00U12401|1|[DBTBL5H]SEQ|[DBTBL1D]:QU ""[DBTBL1D]FID=<<XFID>>""||D VP1^V01S027|D VP2^V01S027"
