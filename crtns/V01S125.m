V01S125(%O,dbtbl22)	; -  - SID= <DBTBL22> DATA-QWIK Aggregate Definition (Master)
	;
...
VTAB(dbtbl22)	;
	...
	S %TAB(3)=$C(3,29,40)_"01U12403|1|[DBTBL22]FRM|||do VP1^V01S125(.dbtbl22)|do VP2^V01S125(.dbtbl22)"
	S %TAB(4)=$C(4,29,40)_"00T12407|1|[DBTBL22]GRP|||do VP3^V01S125(.dbtbl22)|do VP4^V01S125(.dbtbl22)"
	S %TAB(5)=$C(5,29,8)_"20T12404|1|[DBTBL22]RTN"
	S %TAB(6)=$C(6,29,1)_"00L12405|1|[DBTBL22]DTL"
	S %TAB(7)=$C(7,29,1)_"00N12406|1|[DBTBL22]DTP|,0#No Date,1#Calendar Date,2#System Date (CUVAR.TJD)||do VP5^V01S125(.dbtbl22)"
