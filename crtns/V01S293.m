V01S293(%O,fDBSDOM)	; -  - SID= <DBSDOM> User-Defined Data Types Maintenance
	;
...
VTAB(fDBSDOM)	;
	...
	S %TAB(3)=$C(3,27,20)_"01U|*DOM|[*]@DOM|[DBSDOM]||do VP1^V01S293(.fDBSDOM)"
	S %TAB(4)=$C(3,57,1)_"00L|*DELETE|[*]@DELETE|||do VP2^V01S293(.fDBSDOM)"
	S %TAB(5)=$C(3,69,10)_"20T12420|1|[DBSDOM]USER|||||||||20"
	S %TAB(6)=$C(5,2,1)_"00L12401|1|[DBSDOM]PRDES"
	S %TAB(7)=$C(5,27,40)_"01T12401|1|[DBSDOM]DES|||do VP3^V01S293(.fDBSDOM)"
	S %TAB(8)=$C(6,2,1)_"00L12402|1|[DBSDOM]PRTYP"
	S %TAB(9)=$C(6,27,1)_"01U12402|1|[DBSDOM]TYP|[DBCTLDVFM]||do VP4^V01S293(.fDBSDOM)"
	...
	S %TAB(27)=$C(15,27,25)_"00T12408|1|[DBSDOM]MIN|||do VP5^V01S293(.fDBSDOM)"
	S %TAB(28)=$C(16,2,1)_"00L12409|1|[DBSDOM]PRMAX"
	S %TAB(29)=$C(16,27,25)_"00T12409|1|[DBSDOM]MAX|||do VP6^V01S293(.fDBSDOM)"
