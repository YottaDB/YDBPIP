R01S176	; DBCACHE - SQL Cache Usage Report
	;
...
V0	; External report entry point
	...
	N rwrs,vos1,vos2,sqlcur,exe,sqlcur,vd,vi,vsql,vsub S rwrs=$$vOpen0(.exe,.vsql,"SQLCACHE.%LIBS,SQLCACHE.KEY,SQLCACHE.SLOT,SQLCACHE.HIT,SQLCACHE.SIZE,SQLCACHE.LASTDATE,SQLCACHE.TIME,SQLCACHE.PARS,SQLCACHE.EXPR,SQLCACHE.VSQLEXE","SQLCACHE",VWHERE,"SQLCACHE.%LIBS,SQLCACHE.KEY,SQLCACHE.SLOT","","/DQMODE=1")
