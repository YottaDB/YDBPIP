V01S283(%O,fDBTBL5Q)	; -  - SID= <DBTBL5Q> QWIK Report Definition
	;
...
VTAB(fDBTBL5Q)	;
	...
	S %TAB(4)=$C(2,19,40)_"01T12401|1|[DBTBL5Q]DESC||||do VP1^V01S283(.fDBTBL5Q)"
	S %TAB(5)=$C(2,69,8)_"20U12402|1|[DBTBL5Q]PGM"
	S %TAB(6)=$C(3,19,60)_"01U12401|1|[DBTBL5Q]PFID|[DBTBL1]:LIST||do VP2^V01S283(.fDBTBL5Q)"
	S %TAB(7)=$C(4,19,61)_"00T12410|1|[DBTBL5Q]ORDERBY|||do VP3^V01S283(.fDBTBL5Q)|do VP4^V01S283(.fDBTBL5Q)|||||100"
	S %TAB(8)=$C(5,19,60)_"00T12411|1|[DBTBL5Q]BREAKON|||do VP5^V01S283(.fDBTBL5Q)"
	S %TAB(9)=$C(7,1,78)_"01T12401|1|[DBTBL5Q]FLD1|||do VP6^V01S283(.fDBTBL5Q)|do VP7^V01S283(.fDBTBL5Q)"
	S %TAB(10)=$C(8,1,78)_"00T12401|1|[DBTBL5Q]FLD2|||do VP8^V01S283(.fDBTBL5Q)|do VP9^V01S283(.fDBTBL5Q)"
	S %TAB(11)=$C(9,1,78)_"00T12401|1|[DBTBL5Q]FLD3|||do VP10^V01S283(.fDBTBL5Q)|do VP11^V01S283(.fDBTBL5Q)"
	S %TAB(12)=$C(11,21,12)_"00T12401|1|[DBTBL5Q]TRANS|[STBLTFMT]||do VP12^V01S283(.fDBTBL5Q)"
	S %TAB(13)=$C(11,49,1)_"00L12404|1|[DBTBL5Q]DTL"
	S %TAB(14)=$C(11,73,1)_"00L12412|1|[DBTBL5Q]BANNER"
	S %TAB(15)=$C(12,21,1)_"00L12408|1|[DBTBL5Q]STAT|||do VP13^V01S283(.fDBTBL5Q)"
	S %TAB(16)=$C(12,73,1)_"00L12413|1|[DBTBL5Q]MSQL|||do VP14^V01S283(.fDBTBL5Q)"
	S %TAB(17)=$C(14,1,78)_"00T12401|1|[DBTBL5Q]QID1|||do VP15^V01S283(.fDBTBL5Q)"
	S %TAB(18)=$C(15,1,78)_"00T12401|1|[DBTBL5Q]QID2|||do VP16^V01S283(.fDBTBL5Q)"
	S %TAB(19)=$C(16,1,78)_"00T12401|1|[DBTBL5Q]QID3|||do VP17^V01S283(.fDBTBL5Q)"
	S %TAB(20)=$C(17,1,78)_"00T12401|1|[DBTBL5Q]QID4|||do VP18^V01S283(.fDBTBL5Q)"
	S %TAB(21)=$C(18,1,78)_"00T12401|1|[DBTBL5Q]QID5|||do VP19^V01S283(.fDBTBL5Q)"
	S %TAB(22)=$C(19,1,78)_"00T12401|1|[DBTBL5Q]QID6|||do VP20^V01S283(.fDBTBL5Q)"
	S %TAB(23)=$C(20,1,78)_"00T12401|1|[DBTBL5Q]QID7|||do VP21^V01S283(.fDBTBL5Q)"
