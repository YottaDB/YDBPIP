V01S011	;; -  - 5.3 - SID= <DBTBL17> Import/Export DATA-QWIK Definitions
...
VTBL	; Create %TAB(array)
	...
	S %TAB(4)=$C(2,77,1)_"00L|*COMMENT|[*]@COMMENT|||D VP1^V01S011"
	S %TAB(5)=$C(3,15,65)_"01T|*EXPDESC|[*]@EXPDESC"
	S %TAB(6)=$C(7,2,8)_"00U12401|*DDTYPE(1)|[*]@DDTYPE|type(||D VP2^V01S011"
	S %TAB(7)=$C(7,15,1)_"00L12403|*DDTYPE(1)|[*]@DDTYPE"
	S %TAB(8)=$C(7,22,55)_"00T12402|*DDTYPE(1)|[*]@NAME|||D VP3^V01S011|D VP4^V01S011"
	;
	Q
	;
	;
