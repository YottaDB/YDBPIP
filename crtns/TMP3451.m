TMP3451	; DBSEDIT temporary filer compiled program
	;
	; 11/09/2007 10:05 - chenardp
	;
	; Last compiled:  11/09/2007 10:05 AM - chenardp
	;
	; THIS IS A COMPILED ROUTINE.  Compiled by procedure DBSEDIT
	;
	Q:($J'=3451) 
	N rec S rec=$$vDb1("V72FW")
	S:'$D(vobj(rec,-100,"0*","DESC")) vobj(rec,-100,"0*","DESC")="T001"_$P(vobj(rec),$C(124),1) S vobj(rec,-100,"0*")="",$P(vobj(rec),$C(124),1)="Framework MTM"
	S:'$D(vobj(rec,-100,"0*","STARTUP")) vobj(rec,-100,"0*","STARTUP")="T002"_$P(vobj(rec),$C(124),2) S vobj(rec,-100,"0*")="",$P(vobj(rec),$C(124),2)="/v72framework_gtmlx/mtm/V72FRAMEWORK_GTMLX"
