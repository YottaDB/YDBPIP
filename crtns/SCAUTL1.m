...
GETGBLS(GBLS,GLOBAL)	;
	...
	;
	; Table Definition
	N ds1,vos1,vos2 S ds1=$$vOpen1()
	;
	F  Q:'($$vFetch1())  D
	.	N dbtbl1,vop1,vop2,vop3,vop4,vop5 S vop1=$P(ds1,$C(9),1),vop2=$P(ds1,$C(9),2),dbtbl1=$G(^DBTBL(vop1,1,vop2))
	...
	;
	; Index Definition
	N ds2,vos3,vos4,vos5 S ds2=$$vOpen2()
	;
	F  Q:'($$vFetch2())  D
	.	N dbtbl8,vop6,vop7 S vop7=$P(ds2,$C(9),2),vop6=$P(ds2,$C(9),3),dbtbl8=$G(^DBTBL($P(ds2,$C(9),1),8,vop7,vop6))
	.	;
	.	S FID=vop7
...
COMPILE(GBLS)	;
	...
	;
vSIG()	;
	Q "60269^47694^Dan Russell^5064" ; Signature - LTD^TIME^USER^SIZE
	;
...
vFetch1()	;
	...
	I vos1=0 Q 0
	;
	S ds1="SYSDEV"_$C(9)_$S(vos2=$C(254):"",1:vos2)
	;
	Q 1
	;
...
vL2a0	S vos3=0 Q
vL2a1	S vos4=""
vL2a2	S vos4=$O(^DBTBL("SYSDEV",8,vos4),1) I vos4="" G vL2a0
	S vos5=""
vL2a4	S vos5=$O(^DBTBL("SYSDEV",8,vos4,vos5),1) I vos5="" G vL2a2
	Q
	;
vFetch2()	;
	;
	...
	I vos3=0 Q 0
	;
	S ds2="SYSDEV"_$C(9)_$S(vos4=$C(254):"",1:vos4)_$C(9)_$S(vos5=$C(254):"",1:vos5)
	;
	Q 1
