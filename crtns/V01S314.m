V01S314(%O,fDBTBL33)	;DBS -  - SID= <DBTBL33> Batch Definition
	;
...
VTAB(fDBTBL33)	;
	...
	S %TAB(4)=$C(4,28,8)_"01U12402|1|[DBTBL33]PGM|||do VP1^V01S314(.fDBTBL33)|do VP2^V01S314(.fDBTBL33)"
	...
	S %TAB(8)=$C(9,28,50)_"00T12409|1|[DBTBL33]WHERE|||do VP3^V01S314(.fDBTBL33)||||||100"
	S %TAB(9)=$C(10,28,40)_"00T12422|1|[DBTBL33]DISTINCT|||do VP4^V01S314(.fDBTBL33)"
