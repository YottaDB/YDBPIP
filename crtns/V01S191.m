V01S191(%O,dbtbl14q,dbtbl14)	; -  - SID= <DBTBL14> Data-Item Protection
	;
...
VTAB(dbtbl14q,dbtbl14)	;
	...
	S %TAB(8)=$C(9,1,75)_"01T12403||[DBTBL14]RUCLS1|||do VP1^V01S191(.dbtbl14q,.dbtbl14)"
	S %TAB(9)=$C(11,1,70)_"00T12401|1|[DBTBL14Q]QRYDESC|||do VP2^V01S191(.dbtbl14q,.dbtbl14)"
