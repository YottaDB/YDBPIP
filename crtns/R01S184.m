R01S184	; DBSDOMREL - User-Defined Data Type Relationships Rpt
	;
...
V0	; External report entry point
	...
	N rwrs,vos1,vos2,sqlcur,exe,sqlcur,vd,vi,vsql,vsub S rwrs=$$vOpen0(.exe,.vsql,"DBTBL1D.%LIBS,DBTBL1D.DOM,DBTBL1D.FID,DBTBL1D.DI,DBTBL1.DES,DBTBL1D.DES,DBTBL1D.TYP,DBTBL1D.LEN,DBSDOM.DES,DBSDOM.TYP,DBSDOM.LEN","DBTBL1D,DBTBL1,DBSDOM",VWHERE,"DBTBL1D.%LIBS,DBTBL1D.DOM,DBTBL1D.FID,DBTBL1D.DI","","/DQMODE=1")
