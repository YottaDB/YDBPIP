V01S224	;; -  - 5.3 - SID= <DBSRDS> Required Data Item Set Screen
...
VTBL	; Create %TAB(array)
	...
	;
	S %TAB(1)=$C(1,69,1)_"00L|*MPG|[*]@MPG|||D VP1^V01S224"
	S %TAB(2)=$C(5,4,12)_"00T|*KEYNAME(1)|[*]@KEYNAME"
	S %TAB(3)=$C(5,28,52)_"00T|*DITEMLST(1)|[*]@DITEMLST|@SELDI^DBSFUN(FID,.X):LIST:NOVAL||D VP2^V01S224||||||111"
	;
	Q
	;
	;
