...
public   class  ScStatement implements Statement,Serializable,Cloneable
{
    ...
    public void setFetchSize(int rows) throws SQLException
    {
        ...
        if (dBStatement!=null) ((ScMsqlQueryStatement)dBStatement).sqlQuailfier = ((ScMsqlQueryStatement)dBStatement).sqlQuailfier+ "/PREPARE=1/ROWS = "+rows;
        fetchRow = rows;
    }
    ...
    */
    public void setEFD(int julinDate) throws SQLException
    {
        ...
        if (dBStatement!=null) ((ScMsqlDDLStatement)dBStatement).sqlQuailfier = ((ScMsqlQueryStatement)dBStatement).sqlQuailfier + "/EFD= "+julinDate;
            ...
            throws SQLException,Exception
    {
        ...
        finally {i_batchSql.removeAllElements();}
    }
