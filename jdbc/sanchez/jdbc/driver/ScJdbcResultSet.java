   ...
   */
   ...
   //case Types.DECIMAL:
    ...
    public void insertRow() throws SQLException
    {
        ...
        if (fileIndex==0) sqlStatement[fileIndex] = "BUFFER NEW "+String.valueOf(now)+" "+sqlStatement[fileIndex];
    ...
    public void updateRow() throws SQLException
    {
        ...
        if ((fileIndex==0)&&(sqlStatement[fileIndex]!=null)) sqlStatement[fileIndex] = "BUFFER NEW "+String.valueOf(now)+" "+sqlStatement[fileIndex]+ss;
        else if (sqlStatement[fileIndex]!=null) sqlStatement[fileIndex] = "BUFFER ADD "+ String.valueOf(now)+" "+sqlStatement[fileIndex]+ss;
        }//for
    ...
    public void deleteRow() throws SQLException
    {
        ...
        for (fileIndex = 0 ; fileIndex<table.size(); fileIndex++)
        {
		   ...
		   while (result.next())
		   {
            ...
            if (fileIndex==0) sqlStatement[fileIndex] = "BUFFER NEW "+String.valueOf(now)+" DELETE "+fileName+ss;
   ...
   private String getFormatDate(String sDate)
   {
      try{ 
       ...
       catch(Exception e){return sDate;}
   }
   ...
   private String getFormatNumber(int columnIndex,int iType, String sNumber)
   {
      try{ 
       ...
       catch(Exception e){return sNumber;}
   }
   ...
   */ 
   private Timestamp getFormatTimeStamp(String sTimeStamp) throws Exception  // To be Added From here
   {
     ...
     { 
      ...
      catch(Exception e){return Timestamp.valueOf(sTimeStamp);}
   }               
