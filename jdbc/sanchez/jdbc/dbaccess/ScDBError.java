...
public class ScDBError
{
   ...
   * @exception throws java.lang.SQLException
   */
        ...
        throws SQLException
  {
     ...
     catch (Exception e1){vendorCode=0;}
  ...
  public static void set_encoding(String encoding)
  {
        ...
        throws SQLException
    {
        ...
        if (e instanceof ScProfileException)
        {
            if (mess.indexOf("|")>0)
            {
                ...
                if (code.indexOf("RFLG_")<0 && code.indexOf("MSG_")<0 && code.indexOf("OVR_")<0 && code.indexOf("XBAD_")<0) throw new SQLException(mess);
     ...
     * @param iBatchCount
     * @param iUpdateCount
     * @exception throws BatchUpdateException
     */
