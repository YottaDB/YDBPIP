 ...
 * @exception java.lang.Exception Superclass of all Exceptions, a concrete &nbc
 ...
 */
	...
	public  void cleanUp()
	{
		...
		while(enum.hasMoreElements()&& num>=minimumSize)
		{
			o = enum.nextElement();
 ...
 * @exception java.lang.Exception , the concrete subclass may throw &nbc
  ...
  /**
	...
	*/ 
	public synchronized void purge()
	{
		...
		while(enum.hasMoreElements())
		{
			unlocked.remove(enum.nextElement());
		}
	}
	public  synchronized void purge(int a_iNum)
	{
		...
		Enumeration enum = unlocked.keys();		
		while( flag==true)
		for(int number = unlocked.size()-a_iNum;enum.hasMoreElements() && number>0; number--)
		{
			unlocked.remove(enum.nextElement());			
		}
	}
