...
public class ScStringTokenizer extends sanchez.base.ScObject implements Enumeration {
     ...
     * @since   JDK1.0
     */
    public ScStringTokenizer(String str, String delim, boolean returnTokens) {
	currentPosition = 0;
	this.str = str;
     ...
     * @since   JDK1.0
     */
    public ScStringTokenizer(String str, String delim) {
     ...
     * @since   JDK1.0
     */
    public ScStringTokenizer(String str) {
	this(str, " \t\n\r", false);
    }
    ...
    public void setDelemiter(String delim){
       delimiters = delim;
    }
    ...
    public void setCurrentPos(int iPos){
